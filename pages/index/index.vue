<template>
	<view class="u-skeleton">
		...
		:list="['免责声明：小程序内容来源于网络，服务器未存储任何视频，如有侵犯您的权益请告知我们尽快处理']">
		</u-notice-bar>
		<u-sticky offset-top="160" h5-nav-height="0">
		...
		<view class="mx-2">
			...
			<scroll-view scroll-x="true">
				<template v-if="loading">
					...
					<view class="flex align-center justify-between">
						<view style="width: 230rpx;height: 330rpx;border-radius: 10rpx;" class="u-skeleton-fillet mr-2">
						</view>
						<view style="width: 230rpx;height: 330rpx;border-radius: 10rpx;" class="u-skeleton-fillet mr-2">
						</view>
			...
			<template v-if="loading">
				...
				<view class="flex align-center justify-between flex-wrap">
					<view style="width: 210rpx;height: 310rpx;border-radius: 10rpx;" class="u-skeleton-fillet mr-3 mb-2">
					</view>
					<view style="width: 210rpx;height: 310rpx;border-radius: 10rpx;" class="u-skeleton-fillet mr-3 mb-2">
					</view>
